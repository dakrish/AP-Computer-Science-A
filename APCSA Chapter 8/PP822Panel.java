...
public class PP822Panel extends JPanel
...
//-----------------------------------------------------------------
    ...
    
  {
    ...
    {
      page.drawOval (((int) (point1.x - ((int) (Math.sqrt(Math.pow(point2.x-point1.x, 2)+Math.pow(point2.y-point1.y, 2)))))), ((int) (point1.y - ((int) (Math.sqrt(Math.pow(point2.x-point1.x, 2)+Math.pow(point2.y-point1.y, 2)))))), 2*((int) (Math.sqrt(Math.pow(point2.x-point1.x, 2)+Math.pow(point2.y-point1.y, 2)))), 2*((int) (Math.sqrt(Math.pow(point2.x-point1.x, 2)+Math.pow(point2.y-point1.y, 2)))));
    }
  }
