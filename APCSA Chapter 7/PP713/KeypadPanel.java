...
{
  public JLabel keypadDisplay, keypadDisplay1, keypadDisplay2;
  ...
  public KeypadPanel()
  {
    ...
    keypadDisplay.setPreferredSize(new Dimension(100, 900));
    
    keypadDisplay1 = new JLabel (keypadText);
    keypadDisplay1.setFont (new Font ("Helvetica", Font.BOLD, 24));
    keypadDisplay1.setPreferredSize(new Dimension(100, 900));
    
    keypadDisplay2 = new JLabel (keypadText);
    keypadDisplay2.setFont (new Font ("Helvetica", Font.BOLD, 24));
    keypadDisplay2.setPreferredSize(new Dimension(100, 900));
